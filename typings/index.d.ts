declare module "@eazyautodelete/eazyautodelete-db-client" {
    ...
    getGuildSettings(guildId: string): Promise<GuildSettings>;
    createGuildSettings(guildId: string, registered?: number, prefix?: string, premium?: boolean, adminroles?: Array<string>, modroles?: Array<string>): Promise<{
        id: string;
        registered: number;
        prefix: string;
        premium: boolean;
    ...
    updateGuildSettings(guildId: string, registered?: number, prefix?: string, premium?: boolean, adminroles?: Array<string>, modroles?: Array<string>): Promise<{
        id: string;
        registered: number;
        prefix: string;
        premium: boolean;
    ...
    updateChannelSettings(channelId: string, guild: string, registered?: number, limit?: number, mode?: ModeType, ignore?: Array<string>, filters?: Array<FilterType>, regex?: RegExp | null, filterUsage?: FilterUsage): Promise<ChannelSettings>;
