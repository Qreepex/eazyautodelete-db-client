...
class MongoHandler {
  ...
  getUserSettings(userId) {
    return this.user.findOne({ id: userId }).then((data) => {
      return data;
    });
  }
  ...
  deleteUserSettings(userId) {
    return this.user.deleteMany({ id: userId }).then((data) => {
      return data;
    });
  }
  ...
  getGuildSettings(guildId) {
    return this.guild.findOne({ id: guildId }).then((data) => {
      return data;
    });
  }
  ...
  deleteGuildSettings(guildId) {
    return this.guild.deleteMany({ id: guildId }).then((data) => {
      return data;
    });
  }
  ...
  getChannelSettings(channelId) {
    return this.channel.findOne({ id: channelId }).then((data) => {
      return data;
    });
  }
  ...
  deleteChannelSettings(channelId) {
    return this.channel.deleteMany({ id: channelId }).then((data) => {
      return data;
    });
  }
}
